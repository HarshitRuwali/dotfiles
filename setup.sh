...
if [ -f "/etc/arch-release" ]; then
	...
	sudo pacman -S i3-wm i3lock i3status alacritty picom ttf-font-awesome feh arandr optimus-manager lxappearance imagemagick xfce4-power-manger xfce4-screensaver
	...
	echo -e "${GREEN}[+]${NC} You might want to install the following packages: i3-wm, i3lock, i3status, alacritty, picom, ttf-font-awesome, feh, arandr, optimus-manager, lxappearance, imagemagick, xfce4-power-manger, xfce4-screensaver."
