...
if [ -f "/etc/arch-release" ]; then
	...
	sudo pacman -S --needed i3-wm i3lock i3status dmenu alacritty picom ttf-font-awesome feh arandr pasystray playerctl lxappearance imagemagick xfce4-power-manager xfce4-clipman-plugin light-locker
